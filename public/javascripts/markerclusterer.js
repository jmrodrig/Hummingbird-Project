...
ClusterIcon.prototype.onAdd = function() {
  ...
  if (this.visible_) {
    ...
    this.div_.className += "marker-cluster-baloon";
...
ClusterIcon.prototype.createCss = function(pos) {
  ...
  var backgroundColor = this.backgroundColor_ ? this.backgroundColor_ : 'transparent';
  var border = this.border_ ? this.border_ : 'none';
  var borderRadius = this.borderRadius_ ? this.borderRadius_ : '0px';
